...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_TREE_RUBBER = registerKey("add_key_rubber");
    ...
    private static ResourceKey<BiomeModifier> registerKey(String key) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(Magitech.MOD_ID, key));
    }
}
